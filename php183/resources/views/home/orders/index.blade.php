<!DOCTYPE html>
<!-- saved from url=(0045)https://ordercenter.meizu.com/list/index.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script charset="utf-8" src="{{ asset('/home/meizu/js/v.js') }}"></script><script src="{{ asset('/home/meizu/js/hm.js') }}"></script><script src="{{ asset('/home/meizu/js/flow.js') }}"></script><script src="{{ asset('/home/meizu/js/analytics-min.js') }}"></script>
        ...
        <ul class="layout-topbar-right clearfix" id="topbarRight">
            <li class="layout-topbar-right-links layout-topbar-right-cart layout-topbar-right-cart-hide" id="layoutCart">
                <a class="layout-topbar-link" data-mdesc="页头-购物车" data-mtype="store_index_yt_cart" id="layoutCartBtn" href="https://cart.meizu.com/">
                    <i class="layout-font layout-font-cart"></i>购物车<span class="layout-topbar-cart-quantity" id="layoutCartQuantity">6</span>
                </a>
            ...
            <li class="layout-topbar-right-links signin" id="topbarMsgBox">
                <a id="topbarMsg" class="layout-topbar-link has-msg" data-mdesc="页头-消息" data-mtype="store_index_yt_msg" target="_blank" href="https://me.meizu.com/member/message/index">消息</a>
            </li>
            ...
            <li class="layout-member signin">
                <a class="layout-member-link" target="_blank" href="http://me.meizu.com/member/index"><span class="layout-member-username" id="topbarUser">merqi2017</span>的商城<i class="layout-member-triangle"></i></a>
...
<div class="layout-header clearfix">
    ...
    <div class="store-wrap">
        <div class="crumbs">
            <a href="https://store.meizu.com/index.html">首页 &gt;&nbsp;</a><a href="https://me.meizu.com/member/index">我的商城 &gt;&nbsp;</a><a href="https://ordercenter.meizu.com/list/index.html" class="active">我的订单&nbsp;</a>
        </div>
        <div class="main clearfix">
    <div class="left-nav f-fl">
        <div class="nav-main">
            <a href="javascript:;" class="type-title"><i class="iconfont icon-orderCenter"></i>订单中心</a>
            <a href="https://ordercenter.meizu.com/list/index.html" class="ml active" data-mtype="store_mc_order_me" data-mdesc="我的订单">我的订单</a>
            ...
            <a href="https://me.meizu.com/member/address/index" class="ml " data-mtype="store_mc_me_address" data-mdesc="地址管理">地址管理</a>
...
<table class="orderItem">
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">下单时间：<span class="time">{{date('Y-m-d H:i:s',$value->time)}}</span>订单号：<span class="orderNumber">{{$value->code}}</span>
              </div>
          </td>
        </tr>
        <tr class="list-box b-l b-r b-b">
              ...
              <div class="cart-wrap j-CartWrap">
                    <div class="shop j-shop">
                           <div class="item b-t clearfix j-iamMain">
                              <a class="productDetail nameWidth" href="{{ asset('/home/detail') }}/{{ $value->sid }}" target="_blank">
                              <img src="/uploads/shopping/{{$value->avatar}}" class="f-fl"></a>
                              <div class="describe f-fl">
                                  <div class="vertic clearfix">
                                      <span class="clearfix">
                                          <a class="productDetail nameWidth" href="https://detail.meizu.com/item/meilannote5.html" target="_blank">
                                         {{$value->sname}}</a>
                                          <p>
                                             {{$value->color}}
                              ...
                              <input type="hidden" class="orderSn" value="51070643352010224081">
                              <input type="hidden" class="isCart" value="1">
                              <input class="orderSnSon" type="hidden" value="21070643352010226081">
                            </div>
                    </div>
            ...
            <td class="w125 center opreat b-t">
                <ul>
                    <li class="more"><a href="/home/xlist?code={{$value->code}}">查看详情</a></li>

                    @if($value->sid!=2)
                    <li class=""><a href="/home/addr?aid={{$value->aid}}">查看物流</a></li>
                    @endif

                    @if($value->sid==2)
                    <li class=""><a href="">请支付</a></li>
                    @endif
                </ul>
                ...
                <ul class="layout-footer-nav-list">
                    ...
                    <li>
                        <a class="layout-footer-nav-link layout-footer-nav-wechat" href="javascript:;" data-mdesc="关注我们下第4个坑" data-mtype="store_index_yw_follow_4">
                            官方微信
                            <img class="layout-footer-nav-wechat-img" src="./reorder_files/weixin.png" alt="微信二维码">
                        </a>
                    </li>
                </ul>
            </li>
...
<script src="{{ asset('/home/meizu/js/layout-ca70dcecd0.js') }}" type="text/javascript"></script><script type="text/javascript" src="{{ asset('/home/meizu/js/order-newPayment-4c82a7e919.js') }}"></script>
<script>
    var __mzt = __mzt || [];
    (function () {
