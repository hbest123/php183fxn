...
<table class="orderItem">
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">姓名：<span class="time">{{$data->name}}</span>
              </div>
          </td>
        </tr>
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">电话：<span class="time">{{$data->phone}}</span>
              </div>
          </td>
        </tr>
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">所在省市：<span class="time">{{$data->addr}}</span>
              </div>
          </td>
        </tr>
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">详细地址：<span class="time">{{$data->addinfo}}</span>
              </div>
          </td>
        </tr>
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">邮箱：<span class="time">{{$data->email}}</span>
              </div>
          </td>
        </tr>
        ...
        <tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">物流：<span class="time">圆通速递</span>
              </div>
          </td>
        </tr>
