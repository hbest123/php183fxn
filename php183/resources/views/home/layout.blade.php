...
<link rel="icon" href="{{asset('/home/homelte/alls/img/favicon.png')}}')}}" />
<!-- Place favicon.ico in the root directory -->
		
<!-- all css here -->
<!-- bootstrap.min.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/bootstrap.min.css')}}">
<!-- font-awesome.min.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/font-awesome.min.css')}}">
<!-- owl.carousel.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/owl.carousel.css')}}">
<!-- owl.carousel.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/meanmenu.min.css')}}">
<!-- shortcode/shortcodes.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/shortcode/shortcodes.css')}}">
<!-- nivo-slider.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/nivo-slider.css')}}">
<!-- style.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/style.css')}}">
<!-- responsive.css -->
<link rel="stylesheet" href="{{asset('/home/homelte/alls/css/responsive.css')}}">
<script src="{{asset('/home/homelte/alls/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="logo">
						<a href="index.html"><img src="{{asset('/home/homelte/alls/img/logo.png')}}" alt="" /></a>
					</div>
				</div>
										...
										<ol class="mini-products-list">
											...
											<li>
												<a class="product-image" href="product-details.html">
													<img alt="" src="{{asset('/home/homelte/alls/img/cart/1.jpg')}}">
												</a>
											...
											<li>
												<a class="product-image" href="product-details.html">
													<img alt="" src="{{asset('/home/homelte/alls/img/cart/2.jpg')}}">
												</a>
												<div class="product-details">
													<p class="cartproduct-name">
			...
			<div class="col-lg-3 col-md-3">
				<div class="mainmenu-left visible-lg  visible-md">
					...
					<div class="product_vmegamenu">
						<ul>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/1.png')}}" alt="" /> Automotive & Motorcycle</a></li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/2.png')}}" alt="" />Bags, Shoes & Accessories</a></li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/3.png')}}" alt="" /> Cameras & Photo</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/4.png')}}" alt="" /> Computers & Networking</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/5.png')}}" alt="" />Flashlights & Lamps</a>
							</li>
							<li>
								<a href="#"  class="hover-icon"><img src="{{asset('/home/homelte/alls/img/menu-l/6.png')}}" alt="" />Laptops & Accessories</a>
								<div class="vmegamenu">
									<span>
							...
							<li>
								<a href="#" class="hover-icon"><img src="{{asset('/home/homelte/alls/img/menu-l/12.png')}}" alt="" />Sports & Outdoors</a>
								<div class="vmegamenu">
									<span>
							...
							<li>
								<a href="#" class="hover-icon"><img src="{{asset('/home/homelte/alls/img/menu-l/7.png')}}" alt="" />Smartphone & Tablets</a>
							...
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/8.png')}}" alt="" />Health & Beauty</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/9.png')}}" alt="" />Toys & Hobbies</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/10.png')}}" alt="" />Holiday Supplies & Gifts</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/11.png')}}" alt="" />Jewelry & Watches</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/5.png')}}" alt="" />Smartphone & Watches</a>
							</li>
							<li>
								<a href="#"><img src="{{asset('/home/homelte/alls/img/menu-l/4.png')}}" alt="" />Health Watches</a>
							</li>
						</ul>
					</div>
				</div>	
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="newletter-logo">
					<a href="#"><img src="{{asset('/home/homelte/alls/img/logo.png')}}" alt="" /></a>
				</div>
			</div>
					...
					<div class="footer-widget">	
						<div class="footer-widget-img">
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/1.jpg')}}" alt="" /></a>
							</div>
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/2.jpg')}}" alt="" /></a>
							</div>
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/3.jpg')}}" alt="" /></a>
							</div>
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/4.jpg')}}" alt="" /></a>
							</div>
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/5.jpg')}}" alt="" /></a>
							</div>
							<div class="single-img">
								<a href="#"><img src="{{asset('/home/homelte/alls/img/footer/6.jpg')}}" alt="" /></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="payment text-right">
						<a href="#"><img src="{{asset('/home/homelte/alls/img/payment.png')}}" alt="" /></a>
					</div>
				</div>
			</div>
		</div>
...
<!-- all js here -->
<!-- jquery-1.12.0 -->
<script src="{{asset('/home/homelte/alls/js/vendor/jquery-1.12.0.min.js')}}"></script>
<!-- bootstrap.min.js -->
<script src="{{asset('/home/homelte/alls/js/bootstrap.min.js')}}"></script>
<!-- nivo.slider.js -->
<script src="{{asset('/home/homelte/alls/js/jquery.nivo.slider.pack.js')}}"></script>
<!-- jquery-ui.min.js -->
<script src="{{asset('/home/homelte/alls/js/jquery-ui.min.js')}}"></script>
<!-- jquery.magnific-popup.min.js -->
<script src="{{asset('/home/homelte/alls/js/jquery.magnific-popup.min.js')}}"></script>
<!-- jquery.meanmenu.min.js -->
<script src="{{asset('/home/homelte/alls/js/jquery.meanmenu.js')}}"></script>
<!-- jquery.scrollup.min.js-->
<script src="{{asset('/home/homelte/alls/js/jquery.scrollup.min.js')}}"></script>
<!-- owl.carousel.min.js -->
<script src="{{asset('/home/homelte/alls/js/owl.carousel.min.js')}}"></script>		
<!-- plugins.js -->
<script src="{{asset('/home/homelte/alls/js/plugins.js')}}"></script>
<!-- main.js -->
<script src="{{asset('/home/homelte/alls/js/main.js')}}"></script>
</body>
</html>