<!DOCTYPE html>
<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script charset="utf-8" src="myshop_files/v.htm"></script><script src="{{ asset('/home/meizu/js/hm.js') }}"></script><script src="{{ asset('/home/meizu/js/flow.js') }}"></script><script src="{{ asset('/home/meizu/js/analytics-min.js') }}"></script>
    <meta charset="utf-8">
    ...
    <![endif]-->
<link rel="stylesheet" href="{{ asset('/home/meizu/css/index-90a22321fb.css') }}">
    ...
    <div class="mzcontainer">
        ...
        <ul class="layout-topbar-right clearfix" id="topbarRight">
            <li class="layout-topbar-right-links layout-topbar-right-cart layout-topbar-right-cart-hide" id="layoutCart">
                <a class="layout-topbar-link" data-mdesc="页头-购物车" data-mtype="store_index_yt_cart" id="layoutCartBtn" href="http://cart.meizu.com/">
            ...
            <li class="layout-topbar-right-links">
                <a id="topbarOrderMsg" class="layout-topbar-link has-msg" data-mdesc="页头-我的订单" data-mtype="store_index_yt_order" target="_blank" href="http://ordercenter.meizu.com/list/index.html">我的订单</a>
            </li>
            <li class="layout-topbar-right-links signin" id="topbarMsgBox">
                <a id="topbarMsg" class="layout-topbar-link" data-mdesc="页头-消息" data-mtype="store_index_yt_msg" target="_blank" href="http://me.meizu.com/member/message/index">消息</a>
            </li>
            ...
            <li class="layout-topbar-right-links signout"><a class="layout-topbar-link" data-mdesc="页头-未登录状态-注册" data-mtype="store_index_yt_register" target="_blank" href="http://member.meizu.com/register">注册</a></li>
...
<div class="store-wrap">
    <div class="crumbs">
        ...
        <a href="http://me.meizu.com/member/index" class="active">我的商城</a>
    </div>
    <div class="main clearfix">
    <div class="left-nav f-fl">
        <div class="nav-main">
            <a href="javascript:;" class="type-title"><i class="iconfont icon-orderCenter"></i>订单中心</a>
            <a href="http://ordercenter.meizu.com/list/index.html" class="ml " data-mtype="store_mc_order_me" data-mdesc="我的订单">我的订单</a>
            ...
            <a href="http://me.meizu.com/member/coupon/index" class="ml " data-mtype="store_mc_assets_coupon" data-mdesc="我的优惠券">我的优惠券</a>
            <a href="http://me.meizu.com/member/redenvelop/index" class="ml " data-mtype="store_mc_assets_redpacket" data-mdesc="我的红包">我的红包</a>
            <a href="http://mcycle.meizu.com/repo/ticket/list" class="ml " data-mtype="store_mc_assets_mcycleticket" data-mdesc="我的回购券">我的回购券</a>
            <a href="javascript:;" class="type-title"><i class="iconfont icon-serverCenter"></i>服务中心</a>
            <a href="http://ordercenter.meizu.com/refund/index.html" class="ml " style="width: 105px" data-mtype="store_mc_service_refund" data-mdesc="退款退换货跟踪">退款/退换货跟踪</a>
            <a href="http://me.meizu.com/member/service/insurance" class="ml " data-mtype="store_mc_service_insurance" data-mdesc="补办意外保">意外保</a>
            <a href="http://me.meizu.com/member/service/recovery" class="ml " data-mtype="store_mc_service_recovery" data-mdesc="以旧换新">以旧换新</a>
        </div>
    </div>
            ...
            <div class="index-main">
                <div class="top clearfix">
                    <div class="information clearfix f-fl">
                        <div class="pic f-fl">
                                <img src="{{ asset('/home/meizu/images/423ab7a3c1724a0aafaef7ff8a18f492z.png') }}" alt="">
                        </div>
                        <div class="name f-fl">
                            <span>用户{{ $userdetail->nickname }}</span>
                            <span>欢迎您回来！</span>
                        </div>
                        <div class="info f-fl">
                            <ul>
                                <li>Flyme账号：<span>{{ $user->name }}</span></li>
                                <li>绑定手机号：<span>{{ $userdetail->phone }}</span></li>
                                <li class="emailText">绑定邮箱：{{ $user->email }}<span>未绑定</span></li>
                            </ul>
                            <a class="edit" href="{{ url('/home/person/edit') }}/{{ $user->id }}" target="_blank">修改个人信息 &gt;</a>
                        </div>
                    </div>
                ...
                <div class="bottom clearfix">
                    <div class="orderState f-fl">
                        <div class="title clearfix">
                            ...
                            <a class="detail f-fr" href="http://ordercenter.meizu.com/list/index.html" data-mtype="store_mc_orderstatus_all" data-mdesc="查看全部订单">查看全部订单 &gt;</a>
                        </div>
                        <div class="content">
                            <div class="waitPay clearfix">
                                ...
                                <div class="text f-fl">
                                    ...
                                    <a class="detail" href="http://ordercenter.meizu.com/list/index.html?type=0" data-mtype="store_mc_orderstatus_1" data-mdesc="待付款订单">查看全部待付款订单 &gt;</a>
                                </div>
                            </div>
                            <div class="waitDeliver clearfix">
                                ...
                                <div class="text f-fl">
                                    ...
                                    <a class="detail" href="http://ordercenter.meizu.com/list/index.html?type=1" data-mtype="store_mc_orderstatus_2" data-mdesc="待发货订单">查看全部待发货订单 &gt; </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="message f-fl">
                        <div class="title clearfix">
                            ...
                            <a class="f-fr detail" href="http://me.meizu.com/member/message/index" data-mtype="store_mc_msg_all" data-mdesc="查看全部消息">查看全部消息 &gt;</a>
                        </div>
...
<div class="layout-footer clearfix">
    <div class="mzcontainer">
        ...
        <div class="layout-footer-copyright">
            ...
            <a class="layout-footer-copyright-link" hidefocus="true" href="http://www2.res.meizu.com/zh_cn/images/common/icp2.jpg" target="_blank" data-mdesc="底部版权信息第2个坑" data-mtype="store_index_yw_copyright_2">经营许可证编号：粤B2-20130198</a>
            <a class="layout-footer-copyright-link" hidefocus="true" href="http://www2.res.meizu.com/zh_cn/images/common/com_licence.jpg" target="_blank" data-mdesc="底部版权信息第3个坑" data-mtype="store_index_yw_copyright_3">营业执照</a>
...
<script src="{{ asset('/home/meizu/js/layout-ca70dcecd0.js') }}" type="text/javascript"></script>
    <script type="text/javascript" src="{{ asset('/home/meizu/js/index-59fb5a1cb6.js') }}"></script>
    <!--common js-->
<script>
    var __mzt = __mzt || [];
    (function () {
