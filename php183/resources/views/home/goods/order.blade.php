...
<table class="orderItem">
        <tbody><tr class="trHead">
          <td colspan="4" class="title clearfix">
              <div class="f-fl">下单时间：<span class="time">2017-07-06 20:35:43</span>订单号：<span class="orderNumber">51070643352010224081</span>
              </div>
          </td>
        </tr>
              ...
              <div class="cart-wrap j-CartWrap">
                    <div class="shop j-shop">
                           <div class="item b-t clearfix j-iamMain">
                              ...
                              <img src="{{ asset('/home/meizu/js/Cix_s1hGE96AUG5fAAtuFSxnh1Q216.png') }}" class="f-fl"></a>
                              <div class="describe f-fl">
                                  <div class="vertic clearfix">
                                      <span class="clearfix">
                                          <a class="productDetail nameWidth" href="https://detail.meizu.com/item/meilannote5.html" target="_blank">
                                          魅蓝 Note5 全网通公开版 月光银 16GB</a>
                                          <p>
                                            ￥899
×1
                                          </p>
            ...
            <td class="w125 center opreat b-t">
                <ul>
                    <li class="more"><a href="https://ordercenter.meizu.com/detail.html?sn=51070643352010224081&amp;isOld=0&amp;isCart=1" target="_blank">查看详情</a></li>
                </ul>
            </td>
        </tr>
