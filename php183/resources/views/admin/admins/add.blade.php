      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" method="post" action="{{url('/admin/admins/insert')}}">
...
@endif
				<div class="form-group">
                  <label for="exampleInputName">管理员名</label>
            ...
            <div class="form-group">
              ...
              管理员权限: <select class="form-control" name="auth" style="width:120px">
                        <option value="1"
