      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="{{url('/admin/admins/index')}}" method="get">
            <div class ="row">
            <div class="col-md-2">
            <!-- select -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr class="parent">
                 ...
                 <td>普通管理员</td>
                  ...
                  <td><a href="{{ url('/admin/admins/edit') }}/{{ $val->id}}">编辑</a>|<a data-toggle="modal" class ="del" href="#" data-target="#myModal">删除</a></td>
                </tr>
